...
/// # Panics
///
/// If the provided buffer and result do not have an equal length.
pub fn encrypt_block(
    ...
    // TODO(qti3e): After profiling the implementation it appears Rust is not doing this
    // optimization. But right now I'm tired of micro optimization and want to see the code
    // work first...
